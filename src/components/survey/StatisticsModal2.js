...
const StatisticsModal2 = ({ isOpen, onClose, showCloudStatistic2s }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
                <div
                    ...
                    <h2 className="text-xl font-semibold text-center mb-4 dark:text-white">Visão do Coordenador do Sistema</h2>
                        ...
                        <div>
                            {sending ? (
                                ...
                                <div className=" mb-2">
                                    ...
                                    {/*{ showCloudStatistic2s && (*/}
                                        <div className="flex flex-col">
                                            <p className="text-xs font-sans font-medium text-gray-700 dark:text-gray-300 mb-2">
...
export default StatisticsModal2;